...
import SearchResultsMotive from '../components/motive/SearchResultsMotive';
import GenerativeAnswerWrapperMotive from '../components/motive/GenerativeAnswersWrapperMotive';

export const config: HeadlessConfig = {
  apiKey: '04fe371991bcbb105e4d8d7fadeea1e6',
...
const chatConfig: ChatConfig = {
  apiKey: '51dff5f0e8986518ff6fe05e58d69dd5',
  botId: 'motive-chatbot',
};

export default function Motive(): JSX.Element {
                    ...
                    {verticalResults &&
                      ...
                      currentQuery && (
                        <>
                          ...
                          <SearchResultsMotive results={verticalResults} />
                        </>
                      )}
                  </section>
                </motion.div>
